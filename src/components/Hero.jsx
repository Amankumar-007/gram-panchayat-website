    ...
    <div className="bg-white">
      ...
      <section className="bg-blue-50/60 py-10">
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-8 px-4 md:grid-cols-2">
          <img src="/assets/cctv.jpg" alt="CCTV coverage" className="rounded-xl border border-blue-200"/>
          <div>
      ...
      <section className="py-10">
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-8 px-4 md:grid-cols-2">
          ...
          <img src="/assets/roads.jpg" alt="Road upgrades" className="order-1 rounded-xl border border-slate-200 shadow-sm md:order-2"/>
        </div>
      </section>
      ...
      <section className="bg-emerald-50/60 py-10">
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-8 px-4 md:grid-cols-2">
          <img src="/assets/school.jpg" alt="Girls school new rooms" className="rounded-xl border border-emerald-200"/>
          <div>
      ...
      <section className="py-10">
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-8 px-4 md:grid-cols-2">
          ...
          <img src="/assets/bus.jpg" alt="Bus stand" className="order-1 rounded-xl border border-slate-200 shadow-sm md:order-2"/>
        </div>
      </section>
      ...
      <section className="bg-amber-50/60 py-10">
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-8 px-4 md:grid-cols-2">
          <img src="/assets/clean.jpg" alt="Cleanliness drive" className="rounded-xl border border-amber-200"/>
          <div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-12">
        <div className="grid items-center gap-6 rounded-2xl border border-slate-200 bg-slate-50 p-6 md:grid-cols-2">
          <img src="/assets/pdf-snap.jpg" alt="PDF snapshot" className="rounded-xl border border-slate-200"/>
          <div>
